...
const SvgSign = () => {
    ...
    const bounce = keyframes`
        from, 20%, 53%, 80%, to {
            transform: translate(-227.576px,-76.46149px);
            fill:${cssVariables.colors().primaryColorLight};
        }

        40%, 43% {
            transform: translate(-227.576px, -100px);
            fill:${cssVariables.colors().secondaryColorLight};
        }

        70% {
            transform: translate(-227.576px,-90px);
        }

        90% {
            transform: translate(-227.576px,-80px);
        }
`
    const bounceCircle = keyframes`
        ...
        25%{
            fill:${cssVariables.colors(0.6).primaryColorLight};
        }

        50% {
            fill:${cssVariables.colors(0.6).secondaryColorLight};
        }
...
`
    return (
        <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="80%" height="80%" viewBox="0 0 744.84799 747.07702">
            <path id="fa3b9e12-7275-481e-bee9-64fd9595a50d"
                data-name="Path 1"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().bgColor} />
            <path id="bde08021-c30f-4979-a9d8-cb90b72b5ca2"
                data-name="Path 2"
            ...
            <path id="b3ac2088-de9b-4f7f-bc99-0ed9705c1a9d"
                data-name="Path 22"
                d="M747.327,253.4445h-4.092v-112.1a64.883,64.883,0,0,0-64.883-64.883H440.845a64.883,64.883,0,0,0-64.883,64.883v615a64.883,64.883,0,0,0,64.883,64.883H678.352a64.883,64.883,0,0,0,64.882-64.883v-423.105h4.092Z" transform="translate(-227.576 -76.46149)"
                fill={cssVariables.colors().grayColor} className={
                    css(load && {
                        animation: `${bounceCircle} 1s ease infinite`,
            ...
            <path id="b2715b96-3117-487c-acc0-20904544b5b7" data-name="Path 23"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().bgColor} />
            <path id="b06d66ec-6c84-45dd-8c27-1263a6253192"
                data-name="Path 6"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().grayColor}
                className={
                    css(load && {
            ...
            <path id="e73810fe-4cf4-40cc-8c7c-ca544ce30bd4" data-name="Path 7"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().grayColor} className={
                    css(load && {
                        animation: `${bounce} 1s ease infinite`,
                        transformOrigin: `center bottom`,
            ...
            <circle id="a4813fcf-056e-4514-bb8b-e6506f49341f" data-name="Ellipse 1"
                cx="364.43401" cy="261.50202" r="24.45" fill={cssVariables.colors().primaryColorLight} className={
                    css(load && {
                        animation: `${bounceCircle} 1s ease infinite`,
                        transformOrigin: `center bottom`,
                        animationDelay: `0.3333s`
            ...
            <circle id="fcef55fc-4968-45b2-93bb-1a1080c85fc7" data-name="Ellipse 2"
                cx="225.46401" cy="427.41999" r="6.902" fill={cssVariables.colors().primaryColorLight} />
            ...
            <circle id="e8fa0310-b872-4adf-aedd-0c6eda09f3b8" data-name="Ellipse 3" cx="225.46401" cy="496.43702"
                r="6.902" fill={cssVariables.colors().primaryColorLight} />
            <path d="M660.69043,671.17188H591.62207a4.50493,4.50493,0,0,1-4.5-4.5v-24.208a4.50492,4.50492,0,0,1,4.5-4.5h69.06836a4.50491,4.50491,0,0,1,4.5,4.5v24.208A4.50492,4.50492,0,0,1,660.69043,671.17188Z"
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().primaryColorLight} />
            <circle id="e12ee00d-aa4a-4413-a013-11d20b7f97f7"
                data-name="Ellipse 7" cx="247.97799" cy="427.41999" r="6.902" fill={cssVariables.colors().primaryColorLight} />
            <circle id="f58f497e-6949-45c8-be5f-eee2aa0f6586" data-name="Ellipse 8" cx="270.492" cy="427.41999" r="6.902" fill={cssVariables.colors().primaryColorLight} />
            <circle id="b4d4939a-c6e6-4f4d-ba6c-e8b05485017d" data-name="Ellipse 9" cx="247.97799" cy="496.43702" r="6.902" fill={cssVariables.colors().primaryColorLight} />
            <circle id="aff120b1-519b-4e96-ac87-836aa55663de" data-name="Ellipse 10" cx="270.492" cy="496.43702" r="6.902" fill={cssVariables.colors().primaryColorLight} />
            <path id="f1094013-1297-477a-ac57-08eac07c4bd5" data-name="Path 88"
                d="M969.642,823.53851H251.656c-1.537,0-2.782-.546-2.782-1.218s1.245-1.219,2.782-1.219H969.642c1.536,0,2.782.546,2.782,1.219S971.178,823.53851,969.642,823.53851Z" transform="translate(-227.576 -76.46149)" fill="#3f3d56" />
            <path d="M792.25256,565.92292a10.09371,10.09371,0,0,1,1.41075.78731l44.8523-19.14319,1.60093-11.81526,17.92157-.10956-1.05873,27.0982-59.19987,15.65584a10.60791,10.60791,0,0,1-.44749,1.20835,10.2346,10.2346,0,1,1-5.07946-13.68169Z"
            ...
            <path id="ae7af94f-88d7-4204-9f07-e3651de85c05" data-name="Path 99"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().primaryColorLight} />
            <path d="M846.12661,580.70047a10.52561,10.52561,0,0,1,1.50061.70389l44.34832-22.1972.736-12.02551,18.2938-1.26127.98041,27.4126L852.7199,592.93235a10.4958,10.4958,0,1,1-6.59329-12.23188Z"
                transform="translate(-227.576 -76.46149)" fill="#ffb8b8" />
            <path id="a6768b0e-63d0-4b31-8462-9b2e0b00f0fd"
                data-name="Path 101"
