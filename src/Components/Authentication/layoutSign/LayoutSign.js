...
const LayoutSign = () => {
    ...
    return (
        <div className={`w-full h-screen bg-main-x relative transition-all duration-300 overflow-hidden flex items-center justify-center ${hexa}`} >
            <div className='absolute w-full h-screen scale-[1.6] bg-main transition-all duration-200 -top-1/4 -left-1/4 rounded-full z-0'></div>
            <LeftSign />
