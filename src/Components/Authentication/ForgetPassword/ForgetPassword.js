...
import { resetPassword_post } from './../../../Network/auth';
...
const ForgetPassword = () => {
    ...
    const [startResetPassword, error, load] = useSign(resetPassword_post, formik);
    ...
    return (
        ...
        <div className="w-full xl:w-3/4 max-w-3xl py-10 px-5 md:px-10">
            <div className="text-center mb-10">
                ...
                <p className="text-center text-gray-500">Enter your user account's verified email address and we will send you a password
                    reset link.</p>
            </div>
